...
def solve_knapsack(profits, weights, capacity):
    ...
    return solve_knapsack_recurse(profits, weights, capacity, 0, dp)

def solve_knapsack_recurse(profits, weights, capacity, currentIndex, dp):
    n = len(profits)
    ...
    if dp[currentIndex][capacity] == -1:
        ...
        if weights[currentIndex] <= capacity:
            profit1 = profits[currentIndex] + solve_knapsack_recurse(profits, weights, capacity - weights[currentIndex], currentIndex + 1, dp)
        profit2 = solve_knapsack_recurse(profits, weights, capacity, currentIndex + 1, dp)
